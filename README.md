...
รูปภาพที่ 2.5-2.10 เป็นกราฟแสดงค่าแบบเดียวกับรูปภาพที่ 2.3-2.4 แต่เปลี่ยนเป็นการแสดงค่า OSI, TII and HCI ซึ่งผลที่ได้ออกมาคล้ายกับ EGDI โดยสามารถสรุปเฉพาะประเด็นที่น่าสนใจได้ ดังนี้
1. OSI
2. TII
3. HCI
